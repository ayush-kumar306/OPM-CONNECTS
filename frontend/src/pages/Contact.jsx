    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
         ...
         <p className='text-gray-500'>Mob.: <a href="tel:+919142399702" className="hover:underline">+91 9142399702</a> <br />Email: <a href="mailto:opmconnects@gmail.com" className="hover:underline">opmconnects@gmail.com</a></p>
